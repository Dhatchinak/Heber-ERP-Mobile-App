...
class StaffThemeProvider extends ChangeNotifier {
  ...
  Color get surface     => _isDarkMode ? StaffDarkColors.surface     : StaffLightColors.surface;
  Color get elevated    => _isDarkMode ? StaffDarkColors.elevated    : StaffLightColors.elevated;
  Color get elevated2   => _isDarkMode ? StaffDarkColors.elevated2   : StaffLightColors.elevated2;
  Color get border      => _isDarkMode ? StaffDarkColors.border      : StaffLightColors.border;
  Color get borderBright=> _isDarkMode ? StaffDarkColors.borderBright: StaffLightColors.borderBright;
  Color get cyan        => _isDarkMode ? StaffDarkColors.cyan        : StaffLightColors.cyan;
  Color get cyanDim     => _isDarkMode ? StaffDarkColors.cyanDim     : StaffLightColors.cyanDim;
  Color get violet      => _isDarkMode ? StaffDarkColors.violet      : StaffLightColors.violet;
  Color get violetBright=> _isDarkMode ? StaffDarkColors.violetBright: StaffLightColors.violetBright;
  Color get pink        => _isDarkMode ? StaffDarkColors.pink        : StaffLightColors.pink;
  Color get pinkDim     => _isDarkMode ? StaffDarkColors.pinkDim     : StaffLightColors.pinkDim;
  Color get green       => _isDarkMode ? StaffDarkColors.green       : StaffLightColors.green;
  Color get greenDim    => _isDarkMode ? StaffDarkColors.greenDim    : StaffLightColors.greenDim;
  Color get amber       => _isDarkMode ? StaffDarkColors.amber       : StaffLightColors.amber;
  Color get textHigh    => _isDarkMode ? StaffDarkColors.textHigh    : StaffLightColors.textHigh;
  Color get textMid     => _isDarkMode ? StaffDarkColors.textMid     : StaffLightColors.textMid;
  Color get textLow     => _isDarkMode ? StaffDarkColors.textLow     : StaffLightColors.textLow;
  ...
  List<Color> get hodGradient => _isDarkMode
      ? [const Color(0xFF1A0F00), const Color(0xFF2A1800), const Color(0xFF3A2200)]
      : [const Color(0xFFFFF3E0), const Color(0xFFFFE0B2), const Color(0xFFFFCC80)];
  ...
  Color get success => _isDarkMode ? StaffDarkColors.green : StaffLightColors.green;
  Color get warning => _isDarkMode ? StaffDarkColors.amber : StaffLightColors.amber;
  ...
  ThemeData _buildDark() => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: StaffDarkColors.cyan, width: 1.5),
      ),
    ...
    switchTheme: SwitchThemeData(
      thumbColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected) ? StaffDarkColors.cyan : StaffDarkColors.textMid),
  ...
  ThemeData _buildLight() => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: StaffLightColors.cyan, width: 1.5),
      ),
    ...
    switchTheme: SwitchThemeData(
      thumbColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected) ? StaffLightColors.cyan : StaffLightColors.textMid),
      trackColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected)
